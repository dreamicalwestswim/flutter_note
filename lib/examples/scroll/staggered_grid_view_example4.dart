...
class StaggeredGridViewExample4 extends StatefulWidget {
  final String title;

  const StaggeredGridViewExample4({Key? key, required this.title}) : super(key: key);

  @override
  State<StaggeredGridViewExample4> createState() => _StaggeredGridViewExampleState();
}

class _StaggeredGridViewExampleState extends State<StaggeredGridViewExample4> {
  final rnd = Random();
