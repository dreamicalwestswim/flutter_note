...
class StaggeredGridViewExample3 extends StatefulWidget {
  final String title;

  const StaggeredGridViewExample3({Key? key, required this.title}) : super(key: key);

  @override
  State<StaggeredGridViewExample3> createState() => _StaggeredGridViewExampleState();
}

class _StaggeredGridViewExampleState extends State<StaggeredGridViewExample3> {
  final rnd = Random();
